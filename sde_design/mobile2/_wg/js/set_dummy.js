!(function(){
    ...
    p.naverTalk = "http://talk.naver.com/WCBF33";


    
    // 카카오톡 채널
    // https://center-pf.kakao.com/ 에서 로그인후 카카오톡 채널 관리자센터에 들어가신 뒤 좌측 [ 홍보하기 ] 메뉴 클릭후 가입하신 [ 홈 URL ] 을 복사하셔서 아래의 79번줄의 주소를 변경해주세요.
    // p.kakaoCh = "https://pf.kakao.com/_AsBxgxd"; 이런 형태로 들어가면 되겠습니다.
    p.kakaoCh = "https://pf.kakao.com/_AsBxgxd";
